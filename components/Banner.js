...
const Banner = () => {
  ...
  return (
    <div style={{ backgroundImage: `url("images/newBannerBlackfaded.png")`, backgroundSize: 'cover', backgroundPosition: 'center' }} className="w-full flex justify-center overflow-hidden items-center h-[120px] md:h-[200px] relative px-4">
