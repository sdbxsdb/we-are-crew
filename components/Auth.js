      ...
      <div className="flex item-center justify-center">
        <div className="flex justify-between w-full max-w-[1200px] items-center md:h-[calc(100vh-256px)] px-4">
          <div className="flex flex-col-reverse md:flex-row w-full">
            <div className="w-full mt-12 md:mt-4 md:w-4/12 flex flex-col items-start justify-center aboutPage">
            ...
            <div className="flex flex-1 flex-col justify-center items-center mt-8 md:mt-0 px-4">
