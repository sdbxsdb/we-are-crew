...
export default function CrewDetailModal({show, onClose, children}) {
  ...
  const modalContent = show ? (
    <div className="fixed top-12 left-0 flex items-center justify-center w-full h-screen overflow-x-hidden overflow-y-auto bg-wearecrewDarkestGrey/80">
      <div className='rounded-mg max-w-[900px] rounded-md border-b border-wearecrewBlue p-4 flex items-end flex-col z-50 overflow-scroll max-h-[calc(100vh-150px)] w-[95%] bg-white relative shadow-md'>
