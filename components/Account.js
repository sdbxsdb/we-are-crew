                  ...
                  <div className="w-full md:w-[420px]">
                    ...
                    {paid !== true ? (
                      <div className=" items-center">
                        <h1 className="text-white w-full bg-wearecrewOrange p-4 rounded-md text-xl text-center">
                          Pending
                        </h1>
                      ...
                      <div className="">
                        <h1 className="text-white w-full bg-wearecrewGreen p-4 rounded-md text-xl text-center">Live</h1>
                        <small>
