      ...
      <div className="px-12 pt-12">
        ...
        <div className= "flex justify-center w-full">
          <div className="mt-12 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            <DeptCard dept="ADs" imgUrl="../../../images/icons/radio.png"/>
            <DeptCard dept="Camera" imgUrl="../../../images/icons/radio.png"/>
            <DeptCard dept="Grip" imgUrl="../../../images/icons/radio.png"/>
            <DeptCard dept="VFX" imgUrl="../../../images/icons/radio.png"/>
            <DeptCard dept="Costume" imgUrl="../../../images/icons/radio.png"/>
          </div>
        </div>
      </div>
    </>
