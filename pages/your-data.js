            ...
            <div className="w-full flex flex-col md:flex-row gap-x-4 gap-y-4">
              <div className="aboutPageListX w-full md:w-1/2 ">
                ...
                <ul className="mt-4">
                  ...
                  <li>
                    <p>
                      If you delete your profile we won&apos;t store and of your
                      previously saved data.
                    </p>
                  </li>
                  <li>
                    <p>
                      All of our payments are made via Stripe.  An authorised and
                      regulated payment portal. <br /> Get Crew have zero access
                      to your credit or debit card details.
                    </p>
                  </li>
                </ul>
              </div>
              <div className="w-full md:w-1/2 aboutPageListTicks">
                ...
                <ul className="mt-4">
                  <li>
                    <p>
                      We store your data in a secure database for the length of
                      your term.
                    </p>
                  </li>
                  <li>
                    <p>
                      We montior the data you input into your profile to make sure{" "}
                      <br /> there are no breaches in our terms and conditions.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      ...
                      profile <br /> will be viewable by anyone visiting the site.
                    </p>
                  </li>
                </ul>
