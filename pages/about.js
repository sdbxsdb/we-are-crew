        ...
        <div className="flex flex-col items-center justify-center max-w-[1200px] gap-x-4 gap-y-4">
          ...
          <div className="px-4 md:px-12 flex flex-col md:flex-row gap-x-4 gap-y-4 mb-4">
            <div className="w-full md:w-1/2 shadow-md rounded-md p-4 border-b border-wearecrewBlue bg-white">
              ...
              <p>
                ...
                <br />
                <br />
                Create a profile and have it readily accessible to any Producer,
                Production Manager or Production needing crew in the UK or
                Ireland.
                <br />
                <br />
            ...
            <div className="w-full md:w-1/2 aboutPageListTicks shadow-md rounded-md p-4 border-b border-wearecrewBlue bg-white">
              ...
              <ul>
                <li>
                  <p>All your information including availability, CV, credits and more easily viewed and shareable.</p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    No relying on someone else answering a phone or replying to
                    email to check your availability.
                  </p>
                </li>
                <li>
                  <p>
                    1/10<sup>th</sup> of the cost compared to a tradional diary
                    service’s ££££.
                  </p>
                </li>
                <li>
            ...
            <div className="w-full md:w-1/2 aboutPageListNumbers shadow-md rounded-md p-4 border-b border-wearecrewBlue bg-white">
              ...
              <ul>
                ...
                <li>
                  <h1>2.</h1>
                  <span>
                    Save your profile and pay via secure Stripe Payment (you’ll
                ...
                <li>
                  <h1>3.</h1>
                  <span>
                    That’s it! Your profile will be live and ready to be viewed
                    and shared across the biggest productions crewing up or
                    looking for dailies.
                  </span>
                </li>
                <ShowDemoModal />
          ...
          <div className="px-4 md:px-12 flex flex-col md:flex-row gap-x-4 gap-y-4 mb-4">
            <div className="w-full md:w-1/2 shadow-md rounded-md p-4 border-b border-wearecrewBlue bg-white">
              ...
              <p>
                We actively share the platform and encourage the use of Get Crew
                amongst Producers, Line Producers, Production Managers and
                anyone else who needs crew in the UK and Ireland.
              </p>
            </div>
            <div className="w-full md:w-1/2 shadow-md rounded-md p-4 border-b border-wearecrewBlue bg-white">
