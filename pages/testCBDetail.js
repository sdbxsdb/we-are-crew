      ...
      <div className="flex item-center justify-center">
        <div className="flex flex-col justify-center w-full max-w-[1200px] items-center py-12 px-4 gap-12">
          ...
          <div className="flex text-3xl flex-col sm:flex-row gap-4 justify-around items-center sm:w-2/3 w-full">
            <div className="neumorphBoxMd w-full sm:min-w-[180px] sm:w-[180px] h-[180px] flex flex-col items-center justify-center text-center rounded border-b-2 border-wearecrewBlue shadow-md hoverScale gap-y-2 p-2">
